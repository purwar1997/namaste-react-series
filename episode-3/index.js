...
/*
  - Functional components are JS functions which return some piece of JSX code
  - Functional components must start with a capital letter
  - Creating or composing a component by placing another component inside it is called Component Composition
  - To inject javascript expression inside JSX, user {}
  - Only numbers and strings are rendered
  - Boolean values, null and undefined are not rendered
  - Functional components can be rendered like <Component/> or <Component></Component>. Because functional 
    ...
    i.e {Component()}
  - JSX expressions can have only one parent element. To have multiple elements without a parent element 
